...
export default async function Navbar() {
  ...
  return (
    <header className="flex items-center justify-between whitespace-nowrap border-b bg-[#fafbf8] px-4 py-3 sm:px-10">
      <div className="flex items-center gap-4 sm:gap-8">
        <Link href="/dashboard" className="flex items-center gap-2 text-[#131b0e]">
        ...
        <div className="flex items-center gap-4 sm:gap-9">
          <Link className="text-sm font-medium text-[#131b0e]" href="/my-trips">My Trips</Link>
          <Link className="text-sm font-medium text-[#131b0e]" href="/travel-circle">Travel Circle</Link>
          <Link className="text-sm font-medium text-[#131b0e]" href="/rewards">Rewards</Link>
        </div>
      </div>
      ...
      <div className="flex items-center justify-end gap-4">
        {session?.user ? (
          ...
          <Link href="/login">
             {/* Add variant="outline" to change the style */}
